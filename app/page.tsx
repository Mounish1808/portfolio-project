        ...
        <div className="bg-[#09090b]/30 border border-zinc-900/80 p-8 sm:p-10 rounded max-w-2xl space-y-8 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <a 
              ...
              onMouseEnter={() => setIsHovered(true)}
              onMouseLeave={() => setIsHovered(false)}
              className="flex items-center justify-between px-4 py-3.5 border border-zinc-900 rounded bg-zinc-950/60 hover:border-zinc-500 transition-all duration-300 text-[10px] font-bold tracking-widest text-zinc-400 hover:text-white cursor-none"
            >
