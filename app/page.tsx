...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const logs = [
      "CRITICAL_MNT_LOAD: FETCHING DEPENDENCIES...",
      "SECURITY_HANDSHAKE: CONNECTING SHIELD_VAULT...",
      "COMPILING_BLUEPRINTS: PARSING GRAPH_NODES...",
      "OPTIMIZING_INTERFACE: BUILDING TELEMETRY_GRID...",
      "SYSTEM_STATUS: OPERATIONAL. BOOT_SUCCESS."
    ];
