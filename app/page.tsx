...
export default function Home() {
  ...
  return (
    /* Standard cursor restored, circle code gone */
      ...
      <section className="min-h-[70vh] flex flex-col justify-center px-8 py-32 max-w-5xl mx-auto space-y-16 relative z-10">
        ...
        <div className="bg-[#09090b]/30 border border-zinc-900/80 p-8 sm:p-10 rounded max-w-2xl space-y-8 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            >
              <div className="flex items-center gap-2.5">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="12" width="12" xmlns="http://www.w3.org/2000/svg" className="text-zinc-600"><path d="M22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0zM7.12 20.45H3.56V9H7.12v11.45zM5.34 7.43c-1.14 0-2.06-.92-2.06-2.06 0-1.14.92-2.06 2.06-2.06 1.14 0 2.06 0 2.06 2.06v5.7h-3.56V9h3.42v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29z"></path></svg>
                <span>LINKEDIN</span>
              </div>
              <ChevronRight size={10} className="text-zinc-700" />
            </a>
